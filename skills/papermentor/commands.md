...
- major equations;
- exact screenshot/crop of the representative main method/system/algorithm/architecture figure from the PDF/page, attached with `--figure-file` or `--figure-url`; do not redraw it;
