...
- `scan` — produce the paper map before details, including the exact cropped/screenshot main method/system/algorithm figure when present, with explanation underneath. Never substitute Mermaid or a redrawn schematic for the paper figure.
