...
for (const phrase of ['renderWelcomeScreen', 'read slowly, ask precisely', 'learningQuote', 'renderPaletteScreen', 'pm <file-or-url>', 'pm open', 'pm ask "question"', 'pm qa']) {
...
function validateSessionHelper() {
  ...
  try {
    ...
    if (!welcomeOutput.includes('PaperMentor') || !welcomeOutput.includes('Pori') || !welcomeOutput.includes('paste a paper, slides, URL, or ask a question')) failures.push('pm --snapshot should render the minimal PaperMentor chat launcher');
