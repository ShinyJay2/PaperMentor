...
- Choose the formalization from the substance of the question and source context, not from keyword triggers. It may be a likelihood, objective, update rule, intermediate derivation line, minimal definition, or symbolic dependency map; define any hidden state/history/conditioning object rather than leaving it implicit.
